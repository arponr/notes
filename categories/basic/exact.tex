...
%% dear arpon of sunday morning,

%% your plan is use the above identities to show that
%% f + g : A \to B can be factored as A \to B + B \to B.
%% then you'll redefine left and right exact functors
%% as those which preserve finite limits and show that
%% in an additive category the previous factorisation
%% in fact implies any left or right exact functor
%% is additive, leading into the characterisation
%% for left and right exact in abelian categories.

%% best,
%% arpon of saturday night
